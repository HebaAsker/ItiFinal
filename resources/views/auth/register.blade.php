                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-radio">
                            <label for="role" class="radio-label">Select your role :</label>
                            <div class="form-radio-item">
                                <input type="checkbox" name="role" id="student" value="student" onchange="selectRole(this)">
                                <label for="student">Student</label>
                                <span class="check"></span>
                            </div>
                            <div class="form-radio-item">
                                <input type="checkbox" name="role" id="admin" value="admin" onchange="selectRole(this)">
...
<script>
    function selectRole(selectedCheckbox) {
